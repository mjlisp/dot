...
(custom-theme-set-faces
 ...
 ;; '(bold-italic ((t (:slant italic :weight bold :family "DejaVu Sans Mono"))))
 ;; '(italic ((t (:slant italic :family "DejaVu Sans Mono"))))
 '(bold-italic ((t (:slant italic :weight bold :name "Helvetica Neue"))))
 '(italic ((t (:slant italic :name "Helvetica Neue"))))
